...
- Outlook.com / Hotmail (`outlook`) و Microsoft 365 (`office365`): عطلت Microsoft المصادقة الأساسية للحسابات الشخصية, لذا ترفض كلمات مرور التطبيقات على IMAP و POP3 و SMTP, ولا يقبل الإعداد المسبق `outlook` سوى رمز وصول OAuth 2.0 (`accessToken` مع `tokenProvider`); تقبل حسابات العمل أو المدرسة (`office365`) كلمة مرور أو رمز وصول, لكن سياسة المستأجر قد تعطل IMAP أو POP3 أو SMTP AUTH.
...
- Outlook.com / Hotmail: ترفض Microsoft كلمات مرور التطبيقات لثلاثة حسابات على IMAP و POP3 و SMTP (`AUTH_MECHANISM_UNSUPPORTED`), فتنتظر صفوف العمليات رمز وصول; لا توجد حسابات اختبار لكل من iCloud و Yahoo و Aliyun وإعداداتها المسبقة غير متحقق منها.
