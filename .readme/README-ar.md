...
- إذن REQUEST_IGNORE_BATTERY_OPTIMIZATIONS يخدم زر الإرشاد في صفحة الإعدادات فقط: يعرض الزر ما إذا كان النظام قد يوقف الإضافة مؤقتا في الخلفية, ويفتح مربع حوار النظام عند الطلب; لا تطلب الإضافة ذلك من تلقاء نفسها, ولا تعتمد أي ميزة على هذا الاستثناء.
